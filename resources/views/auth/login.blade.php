                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <h3 class="card-header">{{ __('Login') }}</h3>
                                        <h6 class="card-body">Bienvenido a juegos clásicos, Ingresa con tu cuenta o registrate para obtener beneficios.</h6>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6 offset-md-4">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="col-form-label text-md-left" for="remember">
                                                            {{ __('Remember Me') }}
                                                        </label>
                                                    </div>
                                                </div>
